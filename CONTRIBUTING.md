...
## Flujo de trabajo
1. Antes de empezar, lee `CLAUDE.md` y el documento del paso correspondiente en `docs/`.
...
- **Documentación:** cada entregable del roadmap va en su carpeta numerada dentro de `docs/` (ver tabla en `CLAUDE.md`).
